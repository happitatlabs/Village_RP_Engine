...
from village_rp_engine.domain.settlement_data import get_phase1_npc_ids
...
def run_simulation(ticks: int = DEFAULT_SIMULATION_TICKS, mode: Mode = Mode.RP) -> None:
    ...
    for _ in range(ticks):
        action_provider = (
            lambda current_state=snapshot.settlement_state: prompt_player_action(locations, npc_ids, current_state.player_location)
