...
def _deserialize_world_state(data: dict) -> WorldState:
    return WorldState(
        ...
        resident_status=dict(data.get('resident_status', {})),
        recognition_score=dict(data.get('recognition_score', {})),
        recognition_blocked_until_tick=dict(data.get('recognition_blocked_until_tick', {})),
        ...
        quest_refusal_penalty_ticks=dict(data.get('quest_refusal_penalty_ticks', {})),
